...
import { e as eventHandler, f as setResponseHeader, b as send, h as getResponseStatus, i as setResponseStatus, j as setResponseHeaders, u as useNitroApp, k as joinURL, l as useRuntimeConfig, g as getQuery, c as createError, m as getRouteRules, n as getResponseStatusText } from '../runtime.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":""},{"name":"og_title","property":"og:title","content":"Kuroco sample"},{"name":"og_description","property":"og:description","content":"Kuroco sample page"},{"name":"robots","content":"index"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/icon_kuroco.svg"}],"style":[],"script":[],"noscript":[],"title":"Nuxt Auth","htmlAttrs":{"lang":"ja"}};
